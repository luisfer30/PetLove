...
public class CancelarPlanTratamientoTests
{
    ...
    public CancelarPlanTratamientoTests()
    {
    ...
    private CancelarPlanTratamiento CrearCasoDeUso() => new(
    ...
    [Fact]
    public async Task EjecutarAsync_ConPlanActivo_CancelaYCancelaProgramacionesFuturasPendientes()
    {
        ...
        await casoDeUso.EjecutarAsync(new CancelarPlanTratamientoComando(plan.Id, "Mascota falleció"), CancellationToken.None);
