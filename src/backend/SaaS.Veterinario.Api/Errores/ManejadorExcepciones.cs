...
public sealed class ManejadorExcepciones(ILogger<ManejadorExcepciones> logger) : IExceptionHandler
{
    ...
    private static int MapearEstadoHttp(string codigo) => codigo switch
    {
        ...
        CodigosError.TratamientoNoEncontrado => StatusCodes.Status404NotFound,
        CodigosError.TratamientoEstadoInvalido => StatusCodes.Status400BadRequest,
        CodigosError.TratamientoConsultaInvalida => StatusCodes.Status400BadRequest,
        CodigosError.TratamientoRequiereConsultaFinalizada => StatusCodes.Status400BadRequest,
        CodigosError.TratamientoItemNoEncontrado => StatusCodes.Status404NotFound,
        CodigosError.TratamientoItemEstadoInvalido => StatusCodes.Status400BadRequest,
        CodigosError.TratamientoFrecuenciaInvalida => StatusCodes.Status400BadRequest,
        CodigosError.TratamientoHorarioInvalido => StatusCodes.Status400BadRequest,
        CodigosError.ProgramacionNoEncontrada => StatusCodes.Status404NotFound,
        CodigosError.ProgramacionEstadoInvalido => StatusCodes.Status400BadRequest,
        CodigosError.SeguimientoNoEncontrado => StatusCodes.Status404NotFound,
        CodigosError.SeguimientoEstadoInvalido => StatusCodes.Status400BadRequest,
        CodigosError.SeguimientoCitaInvalida => StatusCodes.Status400BadRequest,
